...
const SessionForm = ({ goalId, day, user }: Props) => {
  ...
  const { setClose, data } = UseModalProvider();
    ...
    <AlertDialog>
      <Card className="w-full mt-4">
        <CardHeader>
          ...
          <CardDescription>
            Let&apos;s create a new session for this program goal. You can edit
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input readOnly {...field} value={format(day, "PPPP")} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          {user.role === "COACH" && data.Seance?.id && (
            <div className="flex max-xl:flex-col items-center justify-between rounded-lg border border-destructive gap-4 p-4 mt-4">
              ...
              <div className="text-muted-foreground">
                ...
                goal and remove your data related from our servers.
              </div>
              <AlertDialogTrigger
                disabled={isLoading}
